...
{
	pr_info "make kernel defconfig"
	create_debian_kernel_headers_package ${3} ${PARAM_OUTPUT_DIR}/kernel-headers ${G_VARISCITE_PATH}
...
{
	make_kernel_headers_package ${G_CROSS_COMPILER_PATH}/${G_CROSS_COMPILER_PREFIX} \
